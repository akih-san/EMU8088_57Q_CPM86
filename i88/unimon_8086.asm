...
MON_DSEG	equ	0ff30h
FREE_SEG	equ	0040h
BIOS_IP		equ	2500h		; CP\M-86 BIOS start IP
...
;;;
	...
	if CPM86
CPM86_CODE	equ	FREE_SEG
BIOS_ENTRY	equ	2500h
	endif
;;;
;;; PIC18F57Qxx
;;;
...
NMI_SIG_OFF	equ	30h	; 30h NMI signal off (LED OFF) port
...
IR0:
	...
	mov	ax, BIOS_IP
	mov	[REGIP], ax	; set start IP:100h
	; init break point ip
...
go_anywhere:
	out	NMI_SIG_OFF, al	; NMI LED OFF
...
INTDMY:
	...
	if CPM86
invoke_msg:
	db	"Now invoking Operating System...",CR,LF,0
	endif
