...
void io_rd_wr(void) {
 ...
 if ((board_rd_pin_hook?(*board_rd_pin_hook)():1)) goto io_write;
 ...
 switch (io_addr) {
  ...
  case 0x02:
   (*board_set_data_pins_hook)(((PIR9 & 0x02) | (rx_cnt !=0)));
   break;

  case 0x00:
   (*board_set_data_pins_hook)(rx_buf[rx_rp]);
   rx_rp = (rx_rp + 1) & ( 256 - 1);
   rx_cnt--;
   break;
