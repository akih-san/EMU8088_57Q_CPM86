...
static void emu88_57q_sys_init()
{
 ...
 LATB7 = 1;
    TRISB7 = 0;
# 144 "../src/boards/EMU88RAM.c"
# 1 "../src/boards/clc_pwm3_ready.c" 1
# 10 "../src/boards/clc_pwm3_ready.c"
    CLCIN0PPS = 0x03;
    CLCIN1PPS = 0x05;
    CLCIN2PPS = 0x0b;
    CLCIN3PPS = 0x08;
 ...
 CLCnPOL = 0x0a;
 CLCnCON = 0x82;
# 144 "../src/boards/EMU88RAM.c" 2
# 161 "../src/boards/EMU88RAM.c"
   SLRCONCbits.SLRC0 = 0;
   SLRCONCbits.SLRC1 = 0;
   SLRCONCbits.SLRC2 = 0;
# 260 "../src/boards/EMU88RAM.c"
 PWM3CLK = 0x14;
 PWM3GIE = 0x00;
 PWM3PR = 0x000C;
 PWM3S1P1 = 0x0005;
