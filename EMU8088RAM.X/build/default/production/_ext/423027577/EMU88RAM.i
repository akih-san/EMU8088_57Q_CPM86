...
# 2 "<built-in>" 2
# 1 "../src/boards/EMU88RAM.c" 2
# 26 "../src/boards/EMU88RAM.c"
# 1 "../src/boards/../../src/emu88.h" 1
# 10 "../src/boards/../../src/emu88.h"
# 1 "../src/boards/../../src/../src/picconfig.h" 1
# 10 "../src/boards/../../src/emu88.h" 2
...
# 13 "../src/boards/../../src/emu88.h" 2
# 84 "../src/boards/../../src/emu88.h"
union address_bus_u {
    uint32_t w;
    struct {
        uint8_t ll;
...
# 28 "../src/boards/EMU88RAM.c" 2

# 1 "../src/boards/../../drivers/picregister.h" 1
# 29 "../src/boards/EMU88RAM.c" 2
...
# 33 "../src/boards/EMU88RAM.c" 2
# 84 "../src/boards/EMU88RAM.c"
# 1 "../src/boards/emu88_common.c" 1
# 31 "../src/boards/emu88_common.c"
...
static uint8_t emu88_common_addr_l_pins(void) { return PORTD; }
static void emu88_common_set_addr_l_pins(uint8_t v) { LATD = v; }
static uint8_t emu88_common_data_pins(void) { return PORTC; }
static void emu88_common_set_data_pins(uint8_t v) { LATC = v; }
static void emu88_common_set_data_dir(uint8_t v) { TRISC = v; }
static __bit emu88_common_rd_pin(void) { return RB2; }
static __bit emu88_common_wr_pin(void) { return RB1; }
...
# 1 "../src/boards/clc_pwm3_t2wait.c" 1
# 10 "../src/boards/clc_pwm3_t2wait.c"
    CLCIN0PPS = 0x03;
    CLCIN1PPS = 0x05;
    CLCIN2PPS = 0x0b;
    CLCIN3PPS = 0x08;
...
# 186 "../src/boards/EMU88RAM.c"
 ...
 RB7PPS = 0x1C;
    ...
    for (retry = 0; 1; retry++) {
        ...
        if (SDCard_init(SPI_CLOCK_100KHZ, SPI_CLOCK_2MHZ, 100) == 0)
