...
//
	...
	CLCnSEL1 = 0x38;	// CLC6OUT (delayed IO/M#)
	CLCnSEL2 = 1;		// CLCIN1PPS (HOLDA)
    CLCnSEL3 = 127;		// NC
    ...
    CLCnSEL1 = 0x33;	// CLC1OUT : READY
	CLCnSEL2 = 127;		// NC
    CLCnSEL3 = 127;		// NC

    CLCnGLS0 = 0x01;	// CLK is inverted
	CLCnGLS1 = 0x08;	// READY(not inverted)
    CLCnGLS2 = 0x00;	// not gated
    CLCnGLS3 = 0x00;	// not gated
	...
	CLCnGLS0 = 0x01;	// NCO2 (invert)
	CLCnGLS1 = 0x08;	// IO/#M (no invert)
	CLCnGLS2 = 0x20;	// HOLDA
	CLCnGLS3 = 0x00;	// not gated
